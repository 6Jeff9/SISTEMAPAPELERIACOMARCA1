...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-06-2022 a las 17:44:13
...
INSERT INTO `factura` (`idFactura`, `numeroFact`, `numeroPed`, `fechaCre`, `fechaVen`, `idCategoria`, `idProductos`, `idCliente`, `idAdmin`) VALUES
(6, 55151, 234346, '2022-02-01', '2022-09-09', 1, 3, 1, 3),
(7, 1654, 51541, '2022-05-17', '2022-07-14', 2, 2, 2, 3),
(8, 25451, 2687, '2022-06-01', '2022-06-30', 3, 1, 3, 3),
(9, 3567340, 3345460, '2022-04-10', '2022-06-30', 4, 12, 4, 3),
(10, 541564, 651561, '2021-06-14', '2023-02-21', 5, 11, 5, 3);
